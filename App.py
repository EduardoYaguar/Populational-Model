...
class MyFrame(customtkinter.CTkScrollableFrame):
    def __init__(self, master, **kwargs):
        ...
        self.prey_initial_label.grid(row=1, column=2, padx=10, pady=10)
        self.prey_initial_value = customtkinter.CTkLabel(self, text=f"{self.prey_initial_slider.get():.0f}")
        self.prey_initial_value.grid(row=1, column=1, padx=10, pady=10)
        ...
        self.predator_initial_label.grid(row=2, column=2, padx=10, pady=10)
        self.predator_initial_value = customtkinter.CTkLabel(self, text=f"{self.predator_initial_slider.get():.0f}")
        self.predator_initial_value.grid(row=2, column=1, padx=10, pady=10)
        ...
        self.K_label.grid(row=3, column=2, padx=10, pady=10)
        self.K_value = customtkinter.CTkLabel(self, text=f"{self.K_slider.get():.0f}")
        self.K_value.grid(row=3, column=1, padx=10, pady=10)
        ...
        self.a_label.grid(row=4, column=2, padx=10, pady=10)
        self.a_value = customtkinter.CTkLabel(self, text=f"{self.a_slider.get():.3f}")
        self.a_value.grid(row=4, column=1, padx=10, pady=10)
        ...
        self.b_label.grid(row=5, column=2, padx=10, pady=10)
        self.b_value = customtkinter.CTkLabel(self, text=f"{self.b_slider.get():.3f}")
        self.b_value.grid(row=5, column=1, padx=10, pady=10)
        ...
        self.c_label.grid(row=6, column=2, padx=10, pady=10)
        self.c_value = customtkinter.CTkLabel(self, text=f"{self.c_slider.get():.3f}")
        self.c_value.grid(row=6, column=1, padx=10, pady=10)
        ...
        self.f_label.grid(row=7, column=2, padx=10, pady=10)
        self.f_value = customtkinter.CTkLabel(self, text=f"{self.c_slider.get():.3f}")
        self.f_value.grid(row=7, column=1, padx=10, pady=10)
